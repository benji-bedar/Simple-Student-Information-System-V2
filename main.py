...
def signin():
    ...
    if username=='admin' and password=='1234':
        ...
        #search_icon = r"C:\Users\benji\OneDrive\Desktop\My projects\SSIS\SSISv2\profile.png"
        #search_logo = tk.PhotoImage(file=search_icon)
        root.bind('<Return>', Student.search)
        search_btn = tk.Button(root, bg="black", compound="right", text="SEARCH", foreground="white", relief=tk.RAISED, bd=2, width=10, command=Student.search)
...
#        studList_btn.place(x=1150, y=90, width=150, height=28)
    ...
    elif username_entry!='admin' and password_entry!='1234':
...
Label = tk.Label(login, text='SIGN IN', foreground="Blue", bg="#55a5af", font=('Microsoft YaHei UI Light', 15,'bold'))
Label.place(x=118,y=10)

username_label = tk.Label(login, text="Username:", bg="#55a5af")
username_label.place(x=50,y=60)
username_entry = tk.Entry(login)
username_entry.place(x=150,y=60)

password_label = tk.Label(login, text="Password:", bg="#55a5af")
password_label.place(x=50,y=100)
password_entry = tk.Entry(login, show='*')
password_entry.place(x=150,y=100)

enter = tk.Button(login, text="Sign In", command=signin)
enter.place(x=145, y=150)
